package com.skuniv.modoo.service;

import com.skuniv.modoo.dto.MemberRequestDto;
import com.skuniv.modoo.dto.MemberResponseDto;
import com.skuniv.modoo.member.dao.TokenDao;
import com.skuniv.modoo.dto.TokenRequestDto;
import com.skuniv.modoo.entity.Member;
import com.skuniv.modoo.entity.RefreshToken;
import com.skuniv.modoo.jwt.TokenProvider;
import com.skuniv.modoo.repository.MemberRepository;
import com.skuniv.modoo.repository.RefreshTokenRepository;
...
//                System.out.println("Refresh Token 저장 실패");
            ...
            logger.info("Token issuance successful for user: {}", authentication.getName());
            return tokenDao;
        ...
        // 계정이 잠긴 경우
            ...
            throw new RuntimeException("로그인 중 알 수 없는 오류가 발생했습니다.");
        }
    }
